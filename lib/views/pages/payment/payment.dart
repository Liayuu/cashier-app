...
import 'package:cashier_app/views/components/dropdown_raw.dart';
        ...
        child: Column(
          ...
          children: [
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border.all(
                              color: index == 0 ? Get.theme.primaryColor : Pallete.transparent),
                          borderRadius: BorderRadius.circular(10),
                          color:
                              index == 0 ? Get.theme.unselectedWidgetColor : Get.theme.cardColor),
                      child: Column(
            ...
            Padding(
              ...
              child: Divider(height: 1, color: Get.theme.colorScheme.outline.withOpacity(0.7)),
            ),
            Padding(
